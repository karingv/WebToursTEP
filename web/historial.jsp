...
%>
<%
    listareservas = (ArrayList<Reserva>) request.getAttribute("listareservas");
...
<link rel="stylesheet" type="text/css" href="css/all.css">
    ...
    <script>
        function eliminarReserva(idreserva, idcliente) {
    ...
    <div class="bgded" style="background-image:url('img/principal/01.jpg'); height: 410px">   
    ...
    <div class="wrapper row1">
            <header id="header" class="hoc clear"> 
              ...
              <div id="logo" class="fl_left">
                  <h1><a onclick="regresarPaginaPrincipal()">TEP PERU</a></h1>
              </div>
              <nav id="mainav" class="fl_right">
                <ul class="clear">
                  <li><a onclick="regresarPaginaPrincipal()">INICIO</a></li>
                  <li><a class="drop">REDES SOCIALES</a>
                    <ul>
                      <li><a href="pages/sidebar-left.html">TWITTER</a></li>
                ...
                <table class="table table-hover table-sm">
                    <thead>
                        <tr>
                            ...
                            <th>Cantidad</th>
                            <th>Precio Total</th>
                            <th>Estado de pago de reserva</th>
                        </tr>
                    </thead>
                    <%
                        for (Reserva obj : listareservas) {
                    %> 
                    <tr>
                        
                        <td><%=obj.getNombres()%> <%=obj.getApellidos()%></td>
                        ...
                        <td><%=obj.getEstado()%></td>
                        <td><button class="btn btn-danger" onclick="eliminarReserva('<%=obj.getIdreserva()%>', '<%=obj.getIdcliente()%>')">Eliminar</button></td>
                    </tr>
                    <%  }%>
                </table>
